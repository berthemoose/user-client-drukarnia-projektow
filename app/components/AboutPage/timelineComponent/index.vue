...
<template>
  <div class="max-w-6xl mx-auto px-2 sm:px-4 py-6 sm:py-8">
    <div class="relative">
      ...
      <div
        class="hidden md:block absolute left-1/2 w-1 h-full bg-primary-200 transform -translate-x-1/2"
      ></div>
        ...
        <div class="md:hidden mb-6 last:mb-0">
          <div class="relative pl-0">
            ...
            <div class="w-full mt-2">
              ...
              <div v-else class="aspect-w-16 aspect-h-9 bg-gray-100 rounded-lg flex items-center justify-center text-gray-400">
      ...
      >
        <!-- Timeline dot -->
        <div class="flex-shrink-0 w-6 h-6 rounded-full bg-primary-500 absolute left-1/2 -ml-3 border-4 border-white z-10"></div>
